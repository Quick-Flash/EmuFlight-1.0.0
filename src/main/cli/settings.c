...
#endif // USE_ACRO_TRAINER
    { "rtkf_r_roll",                VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].RTKF_R) },
    { "rtkf_q1_roll",               VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].RTKF_Q1) },
    { "rtkf_q2_roll",               VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].RTKF_Q2) },
    { "rtkf_q3_roll",               VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].RTKF_Q3) },
    { "rtkf_bias_limit_roll",       VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].biasLimit) },
    { "lqr_r_roll",                 VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].LQR_R) },
    { "lqr_q1_roll",                VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].LQR_Q1) },
    { "lqr_q2_roll",                VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].LQR_Q2) },
    { "lqg_beta_roll",              VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].beta) },
    { "lqg_tau_roll",               VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_ROLL].tau) },

    { "rtkf_r_pitch",               VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].RTKF_R) },
    { "rtkf_q1_pitch",              VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].RTKF_Q1) },
    { "rtkf_q2_pitch",              VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].RTKF_Q2) },
    { "rtkf_q3_pitch",              VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].RTKF_Q3) },
    { "rtkf_bias_limit_pitch",      VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].biasLimit) },
    { "lqr_r_pitch",                VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].LQR_R) },
    { "lqr_q1_pitch",               VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].LQR_Q1) },
    { "lqr_q2_pitch",               VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].LQR_Q2) },
    { "lqg_beta_pitch",             VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].beta) },
    { "lqg_tau_pitch",              VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_PITCH].tau) },

    { "rtkf_r_yaw",                 VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].RTKF_R) },
    { "rtkf_q1_yaw",                VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].RTKF_Q1) },
    { "rtkf_q2_yaw",                VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].RTKF_Q2) },
    { "rtkf_q3_yaw",                VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].RTKF_Q3) },
    { "rtkf_bias_limit_yaw",        VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].biasLimit) },
    { "lqr_r_yaw",                  VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].LQR_R) },
    { "lqr_q1_yaw",                 VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].LQR_Q1) },
    { "lqr_q2_yaw",                 VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].LQR_Q2) },
    { "lqg_beta_yaw",               VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].beta) },
    { "lqg_tau_yaw",                VAR_UINT16 | PROFILE_VALUE, .config.minmaxUnsigned = { 0, 50000 },PG_PID_PROFILE, offsetof(pidProfile_t, lqg[FD_YAW].tau) },
